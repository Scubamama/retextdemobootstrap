...
/**
 * The UserInventoryDisplay entity represents a both book and user data used to
 * display books owned by the user as well as their title, author, edition,
 * dept, course number, isbn, and price. Used in the reText app and the
 * user_inventory table in the retext db
 * 
